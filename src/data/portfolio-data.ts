...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    keywords: ["异星居住", "四季系统", "环境设计"],
    tags: ["概念方案", "叙事性表达", "未来场景"],
    overview:
  ...
  },
  {
    ...
    designStatement:
      "「觅踪」是一个位于西安的二次元文化零售体验空间，以「丝路新生，次元织梦」为核心主题。融合西安的丝路起点文脉 with 当代青年热爱的二次元文化，通过「文化转译」与「体验重构」的设计哲学，空间以「丝路」「蚕茧」「丝线」为核心意象，构建了一场引导用户主动探索的寻踪之旅。布局上划分出入口、探索零售、沉浸体验、交流活动和非遗转译等功能区域，由流动的丝线意象串联。「觅踪」不仅是售卖商品的场所，更是孵化文化认同、促进社群连接、激发创造活力的「文化发生场」。",
    highlights: [
  ...
  },
  {
    ...
    tags: ["秦腔文化", "材料转译", "舞台感"],
    overview:
      "《秦土旧腔》围绕地方戏曲文化、舞台感与地域记忆展开设计表达，通过更具情绪与戏剧性的画面组织空间叙事，深度挖掘秦腔这一极具地域特色的戏曲艺术。",
    designStatement:
  ...
  },
  {
    ...
    tags: ["药食同源", "仿生形态", "商业餐饮"],
    overview:
      "《岐黄养生轩》围绕中医养生理念与主题餐饮空间体验展开，尝试在文化识别、商业功能与场景氛围之间建立平衡，致力于将中医非遗融入当代生活。",
    designStatement:
  ...
  },
  {
    ...
    tags: ["未来科技", "感官体验", "电竞空间"],
    overview:
      "《娱乐空间》聚焦更贴近现实使用场景的公共娱乐类空间表达，运用金属与玻璃材质，强化空间的未来感与科技属性，为玩家提供沉浸式的感官体验。",
    designStatement:
  ...
  },
  {
    ...
    tags: ["单体设计", "办公系统", "人体工学"],
    overview:
      "《家具设计》重点展示单体家具在尺度、结构、细节与图像呈现方面的表达能力，Aegis Arc 旨在为新时代的知识工作者提供个人工作解决方案。",
    designStatement:
